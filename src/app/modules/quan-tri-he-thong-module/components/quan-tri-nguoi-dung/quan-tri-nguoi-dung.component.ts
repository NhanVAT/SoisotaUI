...
export class QuanTriNguoiDungComponent implements OnInit {
    ...
    onChange(valueOption, deviceValue) {
       this.selectedDeviceObj = '';
        ...
        switch (deviceValue){
            case 'editUser':
                this.editProduct(this.findProductById(valueOption));
                break;
            case 'deleteUser':
                this.deleteProduct(this.findProductById(valueOption));
                break;
        }
